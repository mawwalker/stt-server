...
echo ""
echo "Usage:"
echo "  ./build/websocket_asr_server --models-root ./models --port 8001"
echo ""
echo "Test with:"
echo "  python websocket_client.py --server ws://localhost:8001/sttRealtime --mode streaming --file examples/test.mp3"
